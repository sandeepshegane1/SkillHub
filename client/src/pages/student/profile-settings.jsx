...
function StudentProfileSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 py-12 px-4 sm:px-6">
            ...
            <Card className="bg-white/5 backdrop-blur-md border border-white/10 shadow-xl overflow-hidden">
              <CardContent className="p-6">
                <div className="flex flex-col items-center">
                  ...
                  <h2 className="text-xl font-bold text-white mt-2">{profileData.userName || 'Student'}</h2>
                  <p className="text-white/60 text-sm">{profileData.userEmail || 'student@example.com'}</p>
